...
export default function ProductCard() {
    const prodImag = 'https://tailwindcss.com/_next/static/media/classic-utility-jacket.0f108046e151c8576017eaf383406fe6.jpg';
    return (
        <div>
            <div className="flex font-sans shadow-sm border border-red-200">
                <div className="flex-none w-48 relative">
                    <img src={prodImag} alt="" className="absolute inset-0 w-full h-full object-cover" />
                </div>
                <form className="flex-auto p-6">
                    ...
                    <div className="flex space-x-4 mb-6 text-sm font-medium">
                        <div className="flex-auto flex space-x-4">
                            ...
                            <button className="h-10 px-6 font-semibold rounded-md border border-gray-200 text-gray-900" type="button">
                                Add to bag
                            </button>
                        </div>
